...
import com.org.zapbook.genericCode.ExcelDataUtil;
...
public class LoginPageTestCase {
	...
	public void verifyLoginPageTestScript(String tcId) {
		List<Map<String, String>> listTestdata = ExcelDataUtil.getAllDataFromExcel("ExcelData\\ReadData.xlsx",
				"verifyLoginTestScript");
		...
		for (int i = 0; i < mapCount; i++) {
			...
			HomePage home = loginObj.validLogin();
			...
			if (scenario.equalsIgnoreCase("Invalid")) {
				// webUtil.validateText(loginObj.getErrorMessage(), expectedErrorMessage, "Error
				// Message");
			} else {
