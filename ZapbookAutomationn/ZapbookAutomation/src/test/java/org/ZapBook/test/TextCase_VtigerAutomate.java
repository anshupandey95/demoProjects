...
public class TextCase_VtigerAutomate {
	...
	public void verifyVCreateNewLeads() {
		...
		webutil.usingWebElementSendKeys(userPasswordEd,"fcv v","userpassword");
		...
		webutil.usingWebElementSendKeys(firstNameEd, "689765", "First Name");
		webutil.usingWebElementSendKeys(lastNameEd, "ydf", "Last Name");
		webutil.usingWebElementSendKeys(companyEd, "", "Company");
		webutil.usingWebElementSendKeys(titleED,"hii", "Title");
		webutil.usingWebElementSendKeys(mobileED, "2154545", "Mobile");
		webutil.usingWebElementSendKeys(emailED, "by862473@gmail.com", "Email");
		webutil.usingWebElementSendKeys(streetEd, "vhbvbmjnb","Street");
